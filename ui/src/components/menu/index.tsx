import { Drawer, Box, Typography, List, ListItem, ListItemButton, ListItemText, Button } from "@mui/material";
...
const SidebarMenu = ({ team, selectedTab, setSelectedTab, drawerWidth, menuItems, player, backButtonPath }: SidebarMenuProps) => {
